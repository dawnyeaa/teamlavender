Shader "VFX/FlipbookInFrontDropShadowEmptyID"
{
    Properties
    {
        ...
        _DropShadColor("Drop Shadow Color", Color) = (1, 1, 1, 1)
        _DropShadOffset("Drop Shadow Offset", Vector) = (0.1, 0.1, 0, 0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 _DropShadColor;
            float2 _DropShadOffset;

            #include "/ParticlesUnlitInputFlipbookDrop.hlsl"
            #include "/ParticlesUnlitForwardPassDrop.hlsl"
